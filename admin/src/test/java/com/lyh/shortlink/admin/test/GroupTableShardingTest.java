package com.lyh.shortlink.admin.test;

/*
 *@title UserTableShardingTest
 *@description
 *@author LYH
 *@version 1.0
 *@create 2024/1/25 9:42
 */
public class GroupTableShardingTest {
    public static final String SQL="CREATE TABLE `t_group_%d`  (\n" +
            "  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',\n" +
            "  `gid` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_bin NULL DEFAULT NULL COMMENT '分组标识',\n" +
            ...
            "  UNIQUE INDEX `idx_unique_gid_username`(`gid` ASC, `username` ASC) USING BTREE\n" +
