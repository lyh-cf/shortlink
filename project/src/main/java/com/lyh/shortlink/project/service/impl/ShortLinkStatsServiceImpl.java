...
/*
 *@title ShortLinkStatsServiceImpl
 *@description 短链接监控接口实现层
 *@author LYH
 *@version 1.0
 *@create 2024/2/22 21:34
 */
@Service
...
public class ShortLinkStatsServiceImpl implements ShortLinkStatsService {
    ...
    public ShortLinkStatsRespDTO oneShortLinkStats(ShortLinkStatsReqDTO requestParam) {
        ...
        //DateUtil.rangeToList 会返回一个包含指定起始日期和结束日期之间所有日期的列表
        //DateField.DAY_OF_MONTH 表示按照每日的粒度来生成日期列表
        ...
        listedLocaleByShortLink.forEach(each -> {
            ...
            //ratio * 100.0将小数表示的比率转换为百分比形式
            //Math.round 方法将结果四舍五入到最接近的整数
